/* =========================================================
   Programmer’s Picnic — Branding v2.4.1 (Mobile FIX)
...
(function () {
  ...
  panel.innerHTML = `
    ...
    <div class="pp-section" data-key="tip"><h3>🧠 Daily Tip <span>−</span></h3><div class="pp-content"></div></div>
    <div class="pp-section" data-key="puzzle"><h3>🧩 Python Puzzle <span>−</span></h3><div class="pp-content"></div></div>
    <div class="pp-section" data-key="link"><h3>🌐 LearnWithChampak <span>−</span></h3><div class="pp-content"></div></div>
  `;
